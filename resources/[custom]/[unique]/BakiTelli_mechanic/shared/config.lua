...
Config.Langs = {
OpenMenu = "[E] - Menu do Mecânico",
NoPrice = "Não tens dinheiro suficiente.",
BuyItem = "Modificação aplicada com sucesso",
ChangeHorns = "Se quiseres testar a buzina alterada, muda para a Câmara Livre com o botão direito do rato",
Clean = "Limpaste o carro",
Repair = "Motor do carro reparado",
AdvancedRepair = "Carro reparado",
Stock = "Stock",
...
Config.ModsList = {
	...
	WindowTint = {
		name = "Película de Vidros",
		img = "./imgs/window.png"
	},
	Liveries = {
		name = "Pinturas Personalizadas",
	...
	ArchCover = {
		name = "Coberturas de Arcos",
		img = "./imgs/archcover.png", 
	},	
	Struts = {
		name = "Barras de Reforço",
		img = "./imgs/struts.png", 
	},	
	AirFilter = {
		name = "Filtro de Ar",
	...
	RearBumpers = {
		name = "Para-choques Traseiro",
		img = "./imgs/rearbumpers.png", 
	},	
	FrontBumpers = {
		name = "Para-choques Dianteiro",
...
Config.Plates = {
	{ name = "Azul em Branco 1", plateindex = 0, price = 150},
	{ name = "Azul em Branco 2", plateindex = 3, price = 150},
	{ name = "Azul em Branco 3", plateindex = 4, price = 150},
	{ name = "Amarelo em Azul", plateindex = 2, price = 250},
	{ name = "Amarelo em Preto", plateindex = 1, price = 500},
}

Config.Neons = {
	{ name = "Branco", neon = {255,255,255}, price = 500},
	{ name = "Azul", neon = {0,0,255}, price = 500},
	{ name = "Azul Elétrico", neon = {0,150,255}, price = 500},
	{ name = "Verde Menta", neon = {50,255,155}, price = 500},
	{ name = "Verde Lima", neon = {0,255,0}, price = 500},
	{ name = "Amarelo", neon = {255,255,0}, price = 500},
	{ name = "Dourado", neon = {204,204,0}, price = 500},
	{ name = "Laranja", neon = {255,128,0}, price = 500},
	{ name = "Vermelho", neon = {255,0,0}, price = 500},
	{ name = "Rosa Suave", neon = {255,102,255}, price = 500},
	{ name = "Rosa Choque", neon = {255,0,255}, price = 500},
	{ name = "Roxo", neon = {153,0,153}, price = 500},
	{ name = "Castanho", neon = {139,69,19}, price = 500},
	{ name = "Sem Néon", neon = {0,0,0}, price = 250},
}

Config.Windowtint = {
	{ name = "Preto Puro", tint = 1, price = 500},
	{ name = "Fumo Escuro", tint = 2, price = 500},
	{ name = "Fumo Claro", tint = 3, price = 500},
	{ name = "Limo", tint = 4, price = 500},
	{ name = "Verde", tint = 5, price = 500},
}

Config.Suspensions = {
	{ name = "Suspensão Rebaixada", mod = 0, price = 100},
	{ name = "Suspensão de Rua", mod = 1, price = 250},
	{ name = "Suspensão Desportiva", mod = 2, price = 500},
	{ name = "Suspensão de Competição", mod = 3, price = 1000},
}

Config.Brakes = {
	{ name = "Travões de Rua", mod = 0, price = 500},
	{ name = "Travões Desportivos", mod = 1, price = 1000},
	{ name = "Travões de Corrida", mod = 2, price = 1500},
}

Config.Engine = {
	{ name = "Motor Nível 3", mod = 2, price = 1500},
	{ name = "Motor Nível 2", mod = 1, price = 3000},
	{ name = "Motor Nível 1", mod = 0, price = 4500},
}

Config.Transmission = {
	{ name = "Transmissão de Rua", mod = 0, price = 500},
	{ name = "Transmissão Desportiva", mod = 1, price = 1000},
	{ name = "Transmissão de Corrida", mod = 2, price = 1500},
}
