...
Text = {
    ...
    ['notenough'] = 'Não tens Pontos de Habilidade suficientes',
    ['enough'] = 'A habilidade foi aplicada com sucesso',

    ['fullhealth'] = "Tens a Vida no máximo",
    ['canuseaddhp'] = "Podes usar /addhp novamente",

    ['fullarmor'] = "Tens a Armadura no máximo",
    ['canuseaddarmor'] = "Podes usar /addarmor novamente",

    ['notallowed'] = "Não tens permissão para usar este comando",
    ['wait5minutes'] = "Ainda não passaram 5 minutos",

    ['wallrecharging'] = "Muro de Defesa a recarregar!",
    ['wallactive'] = "Muro de Defesa Ativo!",
}
