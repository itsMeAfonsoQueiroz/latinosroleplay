...
Config.Discord = {
    ...
    ["IconLarge"] = 'meteo', -- The name of the large icon
    ["IconLargeHoverText"] = 'Meteo Server', -- The hover text of the large icon
    ...
    ["Buttons"] = {
        ...
        {
            text = 'Buy Now!',
            url = 'https://buymeacoffee.com/meteo/e/233890'
        }
    }
}
...
Config.MapText = "Meteo Server" -- This is the name / text shown above the map
