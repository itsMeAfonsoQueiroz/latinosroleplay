    ...
    ['luxury'] = {
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                ...
                defaultVehicle = 'bpursport',
                chosenVehicle = 'bpursport'
            },
            [2] = {
            ...
            [3] = {
                ...
                defaultVehicle = 'phantom8',
                chosenVehicle = 'phantom8'
            },
            [4] = {
                coords = vector4(-1252.07, -364.2, 35.91, 56.44),
                defaultVehicle = 'jes21',
                chosenVehicle = 'jes21'
            },
            [5] = {
                coords = vector4(-1255.49, -365.91, 35.91, 55.63),
                defaultVehicle = 'tcpnhd',
                chosenVehicle = 'tcpnhd'
            },
            [6] = {
                coords = vector4(-1249.21, -362.97, 35.91, 53.24),
                defaultVehicle = 'pistas',
                chosenVehicle = 'pistas'
            },
        }
