            ...
            for _, v in pairs(result) do
                ...
                if type == "depot" and vname ~= nil then
                    ...
                    MenuGarageOptions[#MenuGarageOptions + 1] = {
                        ...
                        disabled = vname == nil,
                        params = {
                            event = "meteo-garages:client:takeOutGarage",
                            args = {
                                vehicle = v,
                                type = type,
                                garage = garage,
...
RegisterNetEvent('meteo-garages:client:takeOutGarage', function(data)
    local type = data.type
...
RegisterNetEvent('qb-garages:client:TakeOutDepot', function(data)
    ...
    if vehicle.depotprice ~= 0 then
        ...
        TriggerEvent("meteo-garages:client:takeOutGarage", data)
    end
end)
