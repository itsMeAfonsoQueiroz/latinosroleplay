...
AddEventHandler('NethushDrones:UseDrone', function()
    local hasRc = QBCore.Functions.HasItem('bdrone')

    if hasRc then
        Drones.Use(Config.Drones[1])
    else
        QBCore.Functions.Notify('You don\'t have the drone!!')
    end
end)
...
AddEventHandler('NethushDrones:UseDrone2', function()
    local hasRc = QBCore.Functions.HasItem('badrone')
...
AddEventHandler('NethushDrones:UseDrone3', function()
    local hasRc = QBCore.Functions.HasItem('bbdrone')
...
AddEventHandler('NethushDrones:UseDrone4', function()
    local hasRc = QBCore.Functions.HasItem('bcdrone')
...
AddEventHandler('NethushDrones:UseDrone5', function()
    local hasRc = QBCore.Functions.HasItem('bddrone')
...
AddEventHandler('NethushDrones:UseDronepolice', function()
    local hasRc = QBCore.Functions.HasItem('policedrone')
