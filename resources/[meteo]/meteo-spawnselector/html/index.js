		...
		if (ed.open === true) {
            ...
            <div id="MDTop">
                ...
                <div style="width: fit-content; height: fit-content; display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 5px;">
                    <h4 style="color: #00dfbd; font-size: 20px; font-weight: 600;">Para onde vamos?</h4>
                    <h4 style="color: #a7b1b9; font-size: 14px;">Clica na localização para acordar</h4>
                </div>
            </div>
            <div id="MDBottomCenter">
                ...
                <h4 id="MDBottomCenterH4">OR <span style="color: #00dfbd; border-bottom: 2px solid #00dfbd; padding-bottom: 3px;">NASCER</span> NA ÚLTIMA LOCALIZAÇÃO</h4>
            </div>
            <div id="MDBottomLeft">
                <div style="width: fit-content; height: fit-content; display: flex; align-items: center; justify-content: center;">
                    <h4 style="color: white; font-size: 17px;">Tempo para a cidade</h4>
                </div>
                <div id="MDBLInside">
