        ...
        Citizen.CreateThread(function()
            while true do
                ...
                if NetworkIsPlayerActive(PlayerId()) then
                    TriggerEvent('meteo-spawn:client:openUI')
                    break
                end
            end
        end)
...
RegisterNetEvent('meteo-spawn:client:openUI', function(value)
...
RegisterNetEvent('meteo-spawn:client:setupSpawns', function(cData, new, apps)
    if not new then
        SendNUIMessage({
