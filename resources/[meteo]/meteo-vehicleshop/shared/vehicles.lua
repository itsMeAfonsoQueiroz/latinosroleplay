...
VehiclesData = {
    ...
    -- custom
    { model = 'meteoc1',  name = 'GTR',                  brand = 'Vulcar',      price = 13000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc2',  name = 'Skyline GTR R34',      brand = 'Vulcar',      price = 15000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc3',  name = 'CX 30',                brand = 'Maibatsu',    price = 12000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc4',  name = 'GT63S',                brand = 'Benefactor',  price = 20000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc5',  name = 'AMG GT',               brand = 'Benefactor',  price = 18000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc6',  name = 'ML63',                 brand = 'Benefactor',  price = 17000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc7',  name = 'GT63S Special',        brand = 'Benefactor',  price = 22000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc8',  name = 'M8',                   brand = 'Schyster',    price = 16000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc9',  name = 'Dawn',                 brand = 'Enus',        price = 25000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc10', name = 'M8 Animated',          brand = 'Schyster',    price = 17000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc11', name = 'Q8',                   brand = 'Obey',        price = 14000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc12', name = 'Huracine Animated',    brand = 'Pegassi',     price = 30000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc13', name = 'Eclipse GSX',          brand = 'Karin',       price = 11000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc14', name = 'Chiron Super Sport',   brand = 'Truffade',    price = 35000, category = 'custom',   type = 'automobile', shop = 'pdm' },
    { model = 'meteoc15', name = 'Tundra',               brand = 'Annis',       price = 13000, category = 'custom',   type = 'automobile', shop = 'pdm' },
}
