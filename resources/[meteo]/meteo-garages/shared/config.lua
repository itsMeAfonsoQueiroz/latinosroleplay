...
Config.Garages = {
    motelgarage = {
        ...
        showBlip = true,
        blipName = 'Garagem Pública',
        blipNumber = 357,
        blipColor = 3,
        type = 'public', -- public, gang, job, Apreendidos
